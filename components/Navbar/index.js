...
export const Navbar = () => {
  ...
  <img src="/city_logo.svg" alt="CityQuest Logo" className="w-12 h-12" />
  <div className="flex flex-col">
    ...
    <div className="flex items-center space-x-1">
      ...
      <div className="hidden lg:flex space-x-4 mr-4 lg:mr-20">
        <button className=" px-4 py-1 rounded-full border border-purple-600 text-purple-600  hover:bg-purple-700 hidden lg:block">
          Create Post
        </button>
        <button className=" bg-purple-600 text-white px-4 py-1 rounded-full hover:bg-purple-100">
          Login
        </button>
      </div>
    </div>
