            ...
            {trendingData.map((item, index) => (
              <SwiperSlide key={index} className="custom-swiper-slide">
                <img
                  ...
                  className="w-full h-[200px] md:h-[300px] bg-white rounded-lg p-5 shadow-lg shadow-gray-200 border border-gray-300"
                />
              </SwiperSlide>
            ))}
          ...
          <div className="flex space-x-4 justify-between">
            ...
            <div className="space-x-3 mt-8 mb-6">
              <button
                ...
                ref={prevRef}
              >
                <span className="arrow prev text-[16px] font-bold leading-none pb-4 text-[#2A2A2A]">
                ❮
                </span>
              </button>
              <button
                ...
                ref={nextRef}
              >
                <span className="arrow next text-[16px] font-bold leading-none pb-4 text-[#2A2A2A]">
                ❯
                </span>
              </button>
            </div>
