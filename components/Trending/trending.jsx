...
const TrendingCarousel = () => {
  ...
  return (
    <div className="container px-5 md:px-6 lg:px-2 mt-[60px] mb-[100px] overflow-hidden">
      ...
      <div className="flex flex-col lg:flex-row lg:space-x-8 items-start justify-center">
            ...
            {trendingData.map((item, index) => (
              <SwiperSlide key={index} className="custom-swiper-slide">
                <img
                  ...
                  className="w-full h-[200px] md:h-[300px] bg-white rounded-lg shadow-2xl"
                />
              </SwiperSlide>
            ))}
        ...
        <div className="flex-col space-y-2 transition-opacity duration-500 ease-in-out xss:space-x-10">
          <button className="border-2 p-1 text-sm lg:text-base text-[#6F33C0] px-4 bg-[#6338A124] xss:ml-8">
          ...
          <div className="flex space-x-4 justify-between">
            <button className="border-2 p-1 px-6 text-sm lg:text-base rounded-3xl text-[#6F33C0] mt-8">
              <a>Locate this event</a>
            </button>
