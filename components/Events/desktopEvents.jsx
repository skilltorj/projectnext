          ...
          <div className=" md:w-auto lg:w-auto">
            <div className="flex justify-between mt-8 md:w-auto">
              ...
              <p className="flex items-center text-sm lg:text-base text-[#6E6E6E]">
                <img src={location} className="mr-2 xss:h-6 text-lg " />
                Codissia Ground
              </p>
            </div>
            ...
            <div className="flex justify-between relative top-[60px]">
              <div>
                <p className="inline-block bg-[#DDD3E9] text-[#6338A1] font-bold p-4 rounded-lg w-[140px]" >
                  
                  {eventDate}
                </p>
                <p className="inline-block bg-[#DDD3E9] text-[#6338A1] font-bold p-4 rounded-lg ml-4 pl-8 w-[140px]"
                  >
                  {eventTime}
                </p>
              </div>
