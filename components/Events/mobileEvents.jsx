      ...
      <div className="relative mx-auto overflow-hidden">
        ...
        <div className="w-full">
          ...
          <div className="relative">
            ...
            <button
              ...
              className="absolute top-12 right-12 transform -translate-y-1/2 bg-white text-black w-6 h-6 rounded-full shadow-md flex items-center justify-center z-10"
            >
              &#8249;
            </button>
            <button
              ...
              className="absolute top-12 right-4 transform -translate-y-1/2 bg-white text-black w-6 h-6 rounded-full shadow-md flex items-center justify-center z-10"
            >
              &#8250;
            </button>
        ...
        <div className="mt-6 px-4">
          <div className="flex items-center justify-between">
            ...
            {/* Location */}
            <p className="flex items-center text-xs sm:text-sm md:text-base text-[#6E6E6E]">
              <FaMapMarkerAlt className="mr-2 text-base md:text-lg text-[#2A2A2A]" />
              Codissia Ground
            </p>
          </div>
          ...
          <div className="flex flex-wrap md:flex-nowrap justify-between items-center gap-2 mt-4 mb-6">
            ...
            <div className="flex flex-wrap gap-2">
              <p className="flex-shrink-0 bg-[#DDD3E9] text-[#6338A1] text-xs font-bold md:text-sm py-2 px-3 md:py-2 md:px-4 rounded-lg">
                {eventDate}
              </p>
              <p className="flex-shrink-0 bg-[#DDD3E9] text-[#6338A1] text-xs font-bold md:text-sm py-2 px-3 md:py-2 md:px-4 rounded-lg">
                {eventTime}
