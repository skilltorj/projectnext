...
export const SearchBar = () => {
  ...
  return (
    <div className="flex flex-wrap items-center justify-center gap-4 max-sm:gap-[8px] p-5 bg-black/30 rounded-lg shadow-lg lg:flex-nowrap lg:gap-8 sm:mx-[90px] backdrop-blur-xl">
      {/* Category Dropdown */}
